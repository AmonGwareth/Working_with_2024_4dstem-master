...
def PantaRheiConvertPrzToPreviewWithScale(saveFolderName, filePath, conversionList, imageFormat):
    ...
    for idx, eintrag in enumerate(conversionList):
        ...
        plt.savefig(os.path.join(savePathSTEMPreview,eintrag.replace('.prz',imageFormat)))
        plt.close()
